...
straight_line_path(ROOT + "line.txt", 10, num_points=100, angle=0, plot=True)
sin_wave_path(ROOT + "sin.txt", 10, num_points=100, left_first=False, amplitude=2, stretch_factor=2, plot=True)
circle_path(ROOT + "circle.txt", 10, num_points=100, plot=True, left_first=True)
