...
"""
TODO:
    - Use HSV Color Thresholding for ping pong balls
    - Update Undistortion module for Oak-D camera
"""
...
class UndistortionModule(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        self.K = np.array([[3098.163330078125, 0.0, 1945.3646240234375], 
                           [0.0, 3098.163330078125, 1092.97509765625], 
                           [0.0, 0.0, 1.0]])
        self.D = np.array([[-3.024759531021118], [-47.612464904785156], [-0.0003203139058314264], [0.0009926768252626061], [284.75054931640625]])
        self.DIM = (3840, 2160)
        self.balance = 1
        self.crop = 0.0
